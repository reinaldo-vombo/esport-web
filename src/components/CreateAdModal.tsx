      ...
      <Dialog.Overlay className='bg-black/70 inset-0 fixed '>
        <Dialog.Content className='fixed bg-[#2A2634] py-8 px-10 text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 rounded-lg w-[488px] shadow-lg'>
          <Dialog.Title className='text-3xl font-black'>Publique um anúncio</Dialog.Title>
            <form onSubmit={handleCreate} className='mt-8 flex flex-col gap-6'>
              ...
              <div className='grid grid-cols-2 gap-6'>
                <div className='flex flex-col gap-2'>
                  <label htmlFor="yearsPlayig">Joga a quantos anos</label>
              ...
              <footer className='mt-4 flex gap-2 justify-end'>
                ...
                <button
                className='bg-violet-500 gap-3 px-5 h-12 font-semibold rounded-md flex items-center hover:bg-violet-600' 
                type='submit'>
